...
export const ROUTE_METADATA: ReadonlyArray<RouteMetadata> = [
  ...
  {
    route: '/gateway/agent-hub/paperclip',
    label: 'Paperclip',
  ...
  {
    route: '/gateway/agent-hub/:agentId',
    label: 'Agent Detail',
    parent_route: '/gateway/agent-hub',
  ...
  {
    route: '/gateway/node-detail',
    label: 'Gateway Node Detail',
    parent_route: '/gateway',
  ...
  {
    route: '/gateway/mobile-tablet',
    label: 'Gateway Mobile / Tablet',
    parent_route: '/gateway',
