...
| 6 | **OpenClaw+ / Build-Wiki / Farmer are worker/runtime systems.** Not deletion targets. Represented as orange (runtime) status. |
...
├── OpenClaw+ Workers.html          Parent → child workers
...
- [ ] OpenClaw+ / Build-Wiki / Farmer render as orange (runtime), not as deletion targets.
...
- Gateway · OpenClaw+ · OpenClaw+ / Build-Wiki / Farmer · Brain systems · Bridge/MCP · Models/tools/integrations
...
- **OpenClaw+ / Fork 2 SMB** — Fork 2 red/blocked.
