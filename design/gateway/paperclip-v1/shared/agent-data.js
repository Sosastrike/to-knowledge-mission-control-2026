...
window.AGENTS = (function () {
  ...
  const agents = [
...

    {
      id: 'space-agent',
      name: 'SpaceAgent',
      role: 'Browser · Firecrawl · YouTube research',
      tagline: 'Web research specialist. Read-biased.',
      ...
      repo_grounding: 'pending',
      caps: ['web browse', 'firecrawl scrape', 'youtube transcript', 'page summarize'],
      models: ['claude-haiku-4-5', 'gpt-5-mini'],
      tools: ['firecrawl', 'youtube-api', 'browser-headless'],
      blocked_reason: null,
      gated_reason: 'Not installed in this environment. Repo grounding pending.',
      pulse: { req_per_min: 0, p95_ms: null, error_rate: 0 },
      summary: 'Browser, Firecrawl, and YouTube research. Read-only by design.'
    },
