...
window.GATEWAY = (function () {
  ...
  const NODES = [
    ...
    { id: 'int.agentmail',    name: 'AgentMail',         type: 'channel', lane: 'right_integration', status: 'yellow', connected: 1, configured: 1, R: 1, W: 1, X: 1, bridge: 1, summary: 'Mail send/receive. Bridge required for outbound.', blocked_reason: 'Bridge Session required to send mail.', lastSuccess: '11m ago' },
