...
window.GATEWAY = (function () {
  ...
  const APPROVAL_CENTER_PROPOSALS = [
    {
    ...
    },
    {
      ...
      components: ['Zapier'],
      allowed_operations: ['list_tools', 'list_zaps', 'inspect_readiness', 'read_metadata'],
      blocked_operations: ['zap_creation', 'zap_execution', 'social_posting', 'external_write'],
      write_enabled: false,
      execute_enabled: false,
      external_writes_enabled: false,
      broad_connector_execution_enabled: false,
  ...
  return {
    STATUS, LANES, NODES, OPENCLOUD_CHILDREN, EDGES, EDGE_READINESS, EDGE_LEGEND, NODE_READINESS, GRAPH_HEALTH, APPROVAL_CENTER_PROPOSALS, BRIDGE_SESSIONS, AUDIT, POLICIES, HEALTH,
