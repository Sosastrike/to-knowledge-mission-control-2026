...
export async function GET(request: NextRequest) {
  ...
  const result = await callModelRouteApi({ user: auth.user, targetAgentId: agentId, action: 'list_model_routes', payload: { filters: Object.fromEntries(request.nextUrl.searchParams.entries()) } })
