...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    approval_contract: {
      ...
      scope: 'all registered tools, skills, models, integrations, Brain adapters, and delivery surfaces available in this environment for this mission',
      allowed_tools: sessionRead.session.allowed_tools,
      allowed_skills: sessionRead.session.allowed_skills,
      allowed_models: sessionRead.session.allowed_models,
      allowed_integrations: sessionRead.session.allowed_integrations,
      allowed_brain_access: sessionRead.session.allowed_brain_access,
      allowed_delivery_surfaces: sessionRead.session.allowed_delivery_surfaces,
      blocked_scopes: sessionRead.session.blocked_scopes,
    ...
    safety: {
      ...
      safety_contract: sessionRead.session.safety_contract,
    },
...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    approval_contract: {
      ...
      every_action_audited: true,
      no_fake_completion: true,
      blocked_scopes: result.session.blocked_scopes,
    },
    safety: result.session.safety_contract,
