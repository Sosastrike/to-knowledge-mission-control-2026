...
export async function POST(request: NextRequest, { params }: { params: Params }) {
  ...
  return ownerApprovalRequired({
    ...
    next_action: 'Use the canonical Tony Telegram Approve/Deny buttons for this exact approval id. Mission Control mirrors state but does not approve directly.',
  })
}
