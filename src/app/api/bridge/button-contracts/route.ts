...
const BUTTONS: ButtonContract[] = [
  ...
  { route: 'agent-network', label: 'Approval queue', endpoint: '/api/bridge/approval-requests', method: 'GET', state: 'READ_ONLY', credential_names: [], approval_required: false, audit_required: false, owner: 'Codex', note: 'Read-only queue placeholder until approval/audit persistence is applied.' },
  { route: 'agent-network', label: 'Approve request', endpoint: '/api/bridge/approval-requests/:id/approve', method: 'POST', state: 'OWNER_APPROVAL_REQUIRED', credential_names: [], approval_required: true, audit_required: true, owner: 'Codex', note: 'Approval decision persistence is locked until the owner-approved migration exists. Backend returns HTTP 423.' },
