...
const BUTTONS: ButtonContract[] = [
  ...
  { route: 'brain-sync', label: 'Brain Sync source status', endpoint: '/api/bridge/brain-sync/status', method: 'GET', state: 'READ_ONLY', credential_names: [], approval_required: false, audit_required: false, owner: 'Codex', note: 'Read-only Agent Zero Brain, MemPalace, Obsidian, Graphify, and Brain Sync visibility. No memory writes, no protected memory changes, no DB migration.' },
