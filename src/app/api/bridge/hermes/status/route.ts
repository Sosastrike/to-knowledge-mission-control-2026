...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    agent: {
      ...
      disallowed_behavior: ['production bridge execution', 'public gateway exposure', 'Tony memory writes', 'credential changes'],
    ...
    provider_registry: {
      ...
      limitation: 'Production bridge disabled until separate owner approval; no public ports, Tony memory connection, or credential changes are enabled here.',
