  ...
  return [
    {
      ...
      current_safe_behavior: 'Read-only readiness and HTTP 423 protected-action stubs only.',
    ...
    },
    {
      ...
      current_safe_behavior: 'Queue placeholder is visible; approve/deny remain locked until tables exist.',
