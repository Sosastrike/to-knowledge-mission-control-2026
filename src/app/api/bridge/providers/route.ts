...
export async function GET(request: NextRequest) {
  ...
  const agentZeroRecordPromise = buildAgentZeroEcosystemAgentRecord({
    ...
    const baseUrl = getAgentZeroBaseUrl()
    const blocker = error instanceof Error ? error.message : 'agent_zero_status_probe_failed'
    return {
      id: 'agent_zero',
      name: 'Agent Zero',
      category: 'agent',
      ...
      runtime_detection: {
        ...
        checked_endpoints: [`${baseUrl}/api/health`],
      ...
      proof_packet: {
        ...
        timestamp: checkedAt,
        runtime_commit: null,
        route_or_service_checked: `${baseUrl}/api/health`,
        result: 'SERVICE_DOWN',
        blocker,
        blocker_class: 'SERVICE_DOWN',
        audit_pointer: null,
      ...
      detail: {
        endpoint: `${baseUrl}/`,
        health_endpoint: `${baseUrl}/api/health`,
        chat_endpoint: `${baseUrl}/api/api_message`,
