...
export async function GET(request: NextRequest) {
  ...
  const commandTemplate = registry.row?.command_or_api || 'node /home/tony/claudeclaw/scripts/claude-video-to-brain.mjs <URL> <agent> <purpose>'
  ...
  return NextResponse.json({
    ...
    state: backendReadyCli ? 'BACKEND_READY_CLI' : 'READ_ONLY',
    blockers,
