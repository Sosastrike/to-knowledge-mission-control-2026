...
const GATEWAY_MAP_NODES: GatewayVisualNode[] = [
  ...
  { id: 'apis', label: 'APIs', lane: 'output', eyebrow: 'output', status: 'gated', statusLabel: 'session gated', capabilities: ['external APIs', 'webhooks'], blockers: ['writes require Bridge Session'], lastTest: 'Gateway policy proof' },
  {
    ...
    eyebrow: 'output',
    status: 'blocked',
    statusLabel: 'registry blocked',
    capabilities: ['server list', 'read-only tool schema discovery', 'Bridge Session-gated tool execution'],
    blockers: ['MCP registry is protected and currently reports SERVICE_DOWN until the approved MCP CLI/config is reachable'],
    lastTest: '/api/mcp/servers',
  },
