...
export const AGENT_INTERFACE_LINKS: ReadonlyArray<AgentInterfaceLink> = [
  ...
  },
  {
    ...
    blocker: 'no_standalone_spaceagent_ui · firecrawl_credential_required · firecrawl_backend_adapter_not_configured · YouTube transcript ready via /api/youtube/transcript · Playwright MCP is local-only on server 127.0.0.1:8931.',
    nextFix: 'Manage SpaceAgent through Mission Control; keep Playwright MCP private, use YouTube transcript first, and surface Firecrawl blockers separately.',
    buttons: {
...
const AGENT_CONTROL_DEFS: Record<AgentSlug, AgentControlDefinition> = {
  ...
  spaceagent: {
    ...
    uiHref: null,
    blocker: 'no_standalone_spaceagent_ui · firecrawl_credential_required · firecrawl_backend_adapter_not_configured',
