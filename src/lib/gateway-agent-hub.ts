...
const GATEWAY_ROUTE_MAP: AgentHubGatewayRouteCdpTruth['routes'] = [
  ...
  { route: '/api/bridge/spaceagent/brain-status', methods: ['GET'], surface: 'space_agent', state: 'READY', bridge_session_required: false, writes_enabled: false, public_exposure: false },
  { route: '/api/bridge/spaceagent/tool-map', methods: ['GET'], surface: 'space_agent', state: 'READY', bridge_session_required: false, writes_enabled: false, public_exposure: false },
  { route: '/api/bridge/spaceagent/certification-proof', methods: ['GET'], surface: 'space_agent', state: 'READY', bridge_session_required: false, writes_enabled: false, public_exposure: false },
  { route: '/api/bridge/spaceagent/quality-scorecard', methods: ['GET'], surface: 'space_agent', state: 'READY', bridge_session_required: false, writes_enabled: false, public_exposure: false },
  { route: '/api/bridge/spaceagent/live-proof-readiness', methods: ['GET'], surface: 'space_agent', state: 'READY', bridge_session_required: false, writes_enabled: false, public_exposure: false },
  { route: '/api/bridge/spaceagent/final-certification', methods: ['GET'], surface: 'space_agent', state: 'READY', bridge_session_required: false, writes_enabled: false, public_exposure: false },
