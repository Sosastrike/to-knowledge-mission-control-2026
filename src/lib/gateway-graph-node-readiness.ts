...
export function buildGatewayGraphNodeReadiness(
  ...
  const nodes: GatewayGraphNodeReadiness[] = [
    ...
    node({ node_id: 'brain.mempalace', label: 'MemPalace', domain: 'brain', status: 'approval_required', primary_reason: 'mempalace_writes_bridge_gated', short_label: 'Read ready · writes guarded', next_action: 'open_gateway_approval_center_for_memory_write_scope', setup_state: 'read_only_active_writes_guarded', per_action_state: 'approval_needed_for_memory_write', lock_scope: 'memory_writes', approval_center_refs: ['approval.mempalace.memory_write'], ui_state_label: 'Palacio / MemPalace · writes guarded', read_ready: true, write_ready: true, execute_ready: false, approval_required: true, last_success_at: '1m ago', last_heartbeat_at: generatedAt }),
    ...
    node({ node_id: 'brain.sync', label: 'Brain Sync', domain: 'brain', status: 'approval_required', primary_reason: 'brain_sync_runtime_ready_writes_guarded', short_label: 'Ready · writes guarded', next_action: 'open_gateway_approval_center_for_brain_sync_write_scope', setup_state: 'readiness_active_writes_guarded', per_action_state: 'approval_needed_for_sync_write', lock_scope: 'brain_sync_writes', approval_center_refs: ['approval.brain_sync.write_scope'], ui_state_label: 'Brain Sync · writes guarded', read_ready: true, write_ready: true, execute_ready: true, approval_required: true, last_success_at: generatedAt, last_heartbeat_at: generatedAt }),
