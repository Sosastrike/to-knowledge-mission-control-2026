...
export const GATEWAY_ROLE_MATRIX: readonly GatewayRoleMatrixEntry[] = [
  ...
  },
  {
    ...
    reports_to: ['owner'],
    supervises: ['agent_zero', 'hermes', 'pi', 'space_agent', 'paperclip', 'mini_agents', 'openclaw_plus', 'opencloud'],
  ...
  },
  {
    ...
    supervises: ['hermes', 'pi', 'space_agent', 'paperclip', 'mini_agents', 'openclaw_plus', 'opencloud'],
