...
export function createGatewayRegistryFromAgentNetwork(
  ...
  const nodes = dedupeGatewayNodes([
    ...
    createGatewayNode({
      ...
      capabilities: [
        ...
        'OpenClaw+ runtime and skills dispatch supervision',
      ...
      statusDetails: {
        ...
        openclaw_plus_executes: 'agents, skills, functions, reports, approvals, telegram_voice_routing, runtime_ledgers, mini_agent_execution, tool_execution_through_gateway_bridge_session',
    ...
    createGatewayNode({
      ...
      status: 'read_only',
      parent: 'openclaw_plus',
      supervisors: ['openclaw_plus', 'paperclip', 'agent_zero', 'hermes', 'pi', 'gateway'],
      executionState: 'proposal_only_until_bridge_session',
      externalWrites: 'requires_bridge_session',
      owner: 'ecosystem',
      visibility: 'owner_visible',
      capabilities: ['gateway-routed reporting', 'Paperclip task supervision', 'OpenClaw+ runtime execution', 'Agent Zero dispatch', 'Hermes workflow support'],
      blockers: [],
      statusDetails: {
        paperclip_supervises_mini_agent_requests: true,
        openclaw_plus_executes_mini_agents: true,
    ...
    createGatewayNode({
      ...
      owner: 'ecosystem',
      visibility: 'owner_visible',
      capabilities: ['agents', 'skills', 'functions', 'reports', 'approvals', 'Telegram/voice routing', 'runtime ledgers', 'mini-agent execution', 'tool execution through Gateway/Bridge Session'],
      blockers: [],
      statusDetails: {
        paperclip_layer: 'workforce_control_plane',
        openclaw_plus_layer: 'runtime_skills_engine',
        paperclip_before_openclaw_plus: true,
        executes_after_paperclip_supervision: true,
  ...
  const hierarchyEdges = [
    ...
    { from: 'openclaw_plus', to: 'paperclip', relation: 'reports_to' },
    ...
    { from: 'openclaw_plus', to: 'existing_agents', relation: 'delegates_to' },
    { from: 'existing_agents', to: 'agent_zero', relation: 'reports_to' },
    { from: 'existing_agents', to: 'paperclip', relation: 'reports_to' },
    { from: 'existing_agents', to: 'openclaw_plus', relation: 'reports_to' },
    ...
    { from: 'openclaw_plus', to: 'mini_agents', relation: 'delegates_to' },
    ...
    { from: 'mini_agents', to: 'openclaw_plus', relation: 'reports_to' },
  ...
  const capabilities = dedupeGatewayCapabilities([
    ...
    createGatewayCapability({
      ...
      execution_requirements: [
        ...
        'bridge_session_required_for_workforce_mutations',
        'paperclip_before_openclaw_plus_runtime_dispatch',
        'no_public_exposure',
      ...
      status_details: {
        summary: 'Paperclip is the Workforce Control Plane before OpenClaw+: it organizes co-worker agents, mini-agent requests, tasks, heartbeats, budgets, issues, work products, approvals, and supervision before OpenClaw+ executes runtime work after sandbox blockers clear.',
        role: 'workforce_company_task_orchestration_layer',
        corrected_gateway_chain: 'owner -> gateway -> agent_zero_pi_hermes -> paperclip -> openclaw_plus -> mini_agents_specialist_agents_skills_tools_reports_approvals',
        paperclip_layer: 'workforce_control_plane',
        openclaw_plus_layer: 'runtime_skills_engine',
...
export const GATEWAY_ROLE_MATRIX: readonly GatewayRoleMatrixEntry[] = [
  ...
  },
  {
    ...
    authority: 'Designs skills, workflows, automations, and Paperclip/OpenClaw+ work plans for Agent Zero review.',
    ...
    active: true,
    archived: false,
    policy_tags: ['hermes_lieutenant', 'can_design_space_agent_skills', 'can_design_paperclip_workflows', 'agent_zero_review_required'],
    owner_visible_summary: 'Hermes is lieutenant and designs skill/workflow specs that route through Paperclip before OpenClaw+ executes anything.',
  },
  {
    id: 'pi',
    label: 'Pi',
  ...
  },
  {
    ...
    owner_visible_summary: 'Paperclip is the Workforce Control Plane before OpenClaw+; production activation stays blocked until dependency audit risk is remediated or formally waived.',
  },
  {
    id: 'existing_agents',
    label: 'Existing Agents',
    role: 'retained_specialist_workforce',
    authority: 'Existing agents remain retained specialist workers executed through OpenClaw+ after Gateway and Paperclip supervision; Paperclip may coordinate task metadata but cannot replace, delete, rename, or self-promote them.',
    reports_to: ['openclaw_plus', 'paperclip', 'agent_zero'],
    supervises: [],
    ...
    policy_tags: [
      ...
      'openclaw_runtime_execution_layer',
      'agent_zero_supervision_required',
      'gateway_route_required',
      'bridge_session_required_for_side_effects',
    ],
    owner_visible_summary: 'Existing agents stay retained as specialist workforce under Paperclip supervision and OpenClaw+ runtime execution.',
  },
  {
    id: 'mini_agents',
    label: 'Mini-agents',
    role: 'temporary_or_reusable_subordinate_workers',
    authority: 'Scoped subordinate workers proposed through Gateway/Paperclip, executed by OpenClaw+ only with parent supervisors, TTL, output contracts, and audit.',
    reports_to: ['openclaw_plus', 'paperclip', 'agent_zero', 'hermes', 'pi'],
    supervises: [],
    execution_mode: 'proposal_only_until_bridge_session',
    can_recommend: false,
    can_design: false,
    ...
    active: true,
    archived: false,
    policy_tags: ['parent_supervisor_required', 'memory_ttl_required', 'no_self_promotion', 'paperclip_supervision_required', 'openclaw_runtime_execution_layer'],
    owner_visible_summary: 'Mini-agents are subordinate workers proposed through Paperclip and executed by OpenClaw+ only after Gateway policy allows it.',
  },
  {
    id: 'ocr_specialist',
    label: 'OCR Specialist',
    role: 'pdf_invoice_contract_ocr_to_structured_json',
    authority: 'Subordinate OCR direct-line candidate that extracts PDF, invoice, contract, and image evidence into structured JSON only after Jarvis concurrence and scoped approval/audit gates exist.',
    reports_to: ['gateway', 'agent_zero', 'hermes'],
    supervises: [],
    execution_mode: 'proposal_only_until_jarvis_concurrence',
    can_recommend: false,
    can_design: false,
    commander: false,
    active: false,
    archived: false,
    policy_tags: ['ocr_direct_line_candidate', 'jarvis_concurrence_required', 'server_side_proxy_required', 'no_browser_api_keys', 'no_external_writes'],
    owner_visible_summary: 'OCR Specialist is visible in Gateway as a proposed direct line. It is blocked until Jarvis concurrence, approval/audit persistence, and a scoped extraction runner exist.',
  },
  {
    id: 'openclaw_plus',
    label: 'OpenClaw+ / ClaudeClaw',
    role: 'runtime_skills_engine',
    authority: 'Runtime and execution layer for agents, skills, functions, reports, approvals, Telegram/voice routing, runtime ledgers, mini-agent execution, and tool execution through Gateway/Bridge Session after Paperclip workforce supervision.',
    reports_to: ['paperclip', 'gateway', 'agent_zero'],
    supervises: ['mini_agents', 'existing_agents', 'skills', 'tools', 'reports', 'approvals'],
    execution_mode: 'worker_runtime_gated_by_gateway_paperclip_and_bridge_session',
    can_recommend: false,
    can_design: false,
    commander: false,
    active: true,
