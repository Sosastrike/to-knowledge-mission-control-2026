...
export function createGatewayRegistryFromAgentNetwork(
  ...
  const capabilities = dedupeGatewayCapabilities([
    ...
    createGatewayCapability({
      ...
      status_details: {
        summary: 'Paperclip can become the workforce operations layer for co-worker agents, tasks, heartbeats, budgets, issues, work products, approvals, and audits after sandbox blockers clear.',
        role: 'workforce_company_task_orchestration_layer',
        repo_audit_status: 'sandbox_audit_complete',
        sandbox_install: 'passed_with_ignore_scripts',
        token_scan: 'passed',
...
export const GATEWAY_ROLE_MATRIX: readonly GatewayRoleMatrixEntry[] = [
  ...
  },
  {
    ...
    reports_to: ['owner'],
    supervises: ['agent_zero', 'hermes', 'pi', 'space_agent', 'paperclip', 'existing_agents', 'mini_agents', 'openclaw_plus', 'opencloud'],
  ...
  },
  {
    ...
    supervises: ['hermes', 'pi', 'space_agent', 'paperclip', 'existing_agents', 'mini_agents', 'openclaw_plus', 'opencloud'],
  ...
  },
  {
    ...
    label: 'Paperclip',
    role: 'workforce_company_task_orchestration_layer',
    authority: 'Coordinates co-worker agents, daily tasks, simultaneous jobs, recurring heartbeats, budgets, costs, issues, work products, governance records, and approvals under Gateway and Agent Zero.',
    reports_to: ['gateway', 'agent_zero'],
    supervises: ['co_worker_agents', 'task_queues', 'heartbeats', 'budgets', 'work_products'],
    ...
    owner_visible_summary: 'Paperclip is proposed as the workforce operations layer, but production activation stays blocked until dependency audit risk is remediated or formally waived.',
  },
  {
    id: 'existing_agents',
    label: 'Existing Agents',
    role: 'retained_specialist_workforce',
    authority: 'Existing agents remain retained specialist workers under Gateway and Agent Zero; Paperclip may coordinate task metadata later but cannot replace, delete, rename, or self-promote them.',
    reports_to: ['gateway', 'agent_zero'],
    supervises: [],
    ...
    owner_visible_summary: 'Existing agents stay retained as specialist workforce and remain subordinate to Gateway and Agent Zero.',
  },
  {
    id: 'mini_agents',
    label: 'Mini-agents',
