...
export const GATEWAY_CANONICAL_TELEMETRY_IDENTITIES: GatewayCanonicalTelemetryIdentity[] = [
  ...
  {
    canonical_agent_id: 'brain.obsidian',
    canonical_node_id: 'brain.obsidian',
    canonical_edge_id: 'highway.knowledge.brain.obsidian',
    route_group: 'knowledge',
    telemetry_source_id: 'knowledge_runtime_events',
    aliases: ['brain.obsidian', 'obsidian', 'obsidian vault', 'obsidian-vault'],
  },
  {
    canonical_agent_id: 'brain.mempalace',
    canonical_node_id: 'brain.mempalace',
    canonical_edge_id: 'highway.knowledge.brain.mempalace',
    route_group: 'knowledge',
    telemetry_source_id: 'knowledge_runtime_events',
    aliases: ['brain.mempalace', 'mempalace', 'mem palace', 'mem-palace', 'palacio', 'main policy'],
  },
  {
    canonical_agent_id: 'brain.graphify',
    canonical_node_id: 'brain.graphify',
    canonical_edge_id: 'highway.knowledge.brain.graphify',
    route_group: 'knowledge',
    telemetry_source_id: 'knowledge_runtime_events',
    aliases: ['brain.graphify', 'graphify', 'graffiti', 'graph runtime', 'brain graph'],
  },
  {
    canonical_agent_id: 'brain.sync',
    canonical_node_id: 'brain.sync',
    canonical_edge_id: 'highway.knowledge.brain.sync',
    route_group: 'knowledge',
    telemetry_source_id: 'knowledge_runtime_events',
    aliases: ['brain.sync', 'brain sync', 'brain-sync', 'brain synchronization', 'brain bridge'],
  },
  {
    canonical_agent_id: 'input.telegram',
    canonical_node_id: 'input.telegram',
    canonical_edge_id: 'highway.inputs.input.telegram',
    route_group: 'inputs',
    telemetry_source_id: 'gateway_event_bus',
    aliases: ['input.telegram', 'telegram', 'telegram owner', 'owner telegram'],
  },
  {
  ...
  },
  {
    ...
    route_group: 'inputs',
    telemetry_source_id: 'agent_request_events',
    aliases: ['agent.space', 'space agent', 'spaceagent', 'space-agent', 'space_agent'],
  },
  {
    ...
    route_group: 'inputs',
    telemetry_source_id: 'agent_request_events',
    aliases: ['agent.paperclip', 'paperclip', 'paper clip', 'paper-clip', 'paper_clip'],
  },
  {
