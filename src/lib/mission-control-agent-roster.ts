...
export const MISSION_CONTROL_AGENTS: MissionControlAgent[] = [
  ...
  },
  {
    ...
    classification: 'mission_control_agent',
    status: 'PARTIAL / MISSION CONTROL PANEL ONLY',
    status_endpoint: '/api/spaceagent/status',
    visible_to_gateway: true,
    visible_to_PI: true,
    visible_to_agent_runtime: false,
    execution_allowed: false,
    bridge_required: true,
    adapter_present: true,
    credential_policy: 'playwright_local_only_firecrawl_youtube_separately_gated',
    health: 'partial',
    blocker: 'no_standalone_spaceagent_ui',
  },
  {
    id: 'openclaw-plus',
    label: 'OpenClaw+',
